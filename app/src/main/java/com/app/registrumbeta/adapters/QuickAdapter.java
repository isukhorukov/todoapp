...
public class QuickAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.list_item_quick, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        CheckBox checkBoxQuick = (CheckBox) view.findViewById(R.id.checkbox_quick);
        ...
        checkBoxQuick.setChecked(cursor.getInt(CriteriaFragment.COL_TASK_QUICK) == 0 ? false : true);

        //check for make done
        checkBoxQuick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(checked) {
                    ...
                    values.clear();
                    values.put(TaskContract.TaskEntry.COLUMN_QUICK, 1);
